# Generated individual crop NPK preferences for all crops
# Based on category preferences with deterministic variations
...
# Print summary
print(f"Generated NPK preferences for {len(INDIVIDUAL_CROP_NPK)} crops")
print("\nSample entries:")
for i, (crop, npk) in enumerate(INDIVIDUAL_CROP_NPK.items()):
    if i < 5:
        print(f"{crop}: {npk}")
